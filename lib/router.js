...
router.get('/weibo/search/hot2', lazyloadRouteHandler('./routes/weibo/search/hot2'));
...
router.get('/huxiu/article/:keyword?', lazyloadRouteHandler('./routes/huxiu/article'));
...
// 郑州
router.get('/gov/zhengzhou/news', lazyloadRouteHandler('./routes/gov/zhengzhou/news'));
